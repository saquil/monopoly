...
public class Fonts {
	/**
	 * Affiche une chaine de caractere dynamiquement à l'aide de l'objet
	 * graphics
	 * 
	 * @param g
	 ...
	 * @param x
	 *            La position x en coordonées euclidienne de la chaine de
	 *            caractère
	 * @param y
	 *            La position y en coordonées euclidienne de la chaine de
	 *            caractère
	 * @param width
	 *            La largeur maximale pour cette chaine de caractère
	 */
	...
	/**
	 * Fixe la taille de la police de caractères
	 * @param g L'objet graphics 
	 * @param size La taille souhaité en pixels pour la police
	 * @param nolimit Si ce paramètre vaut TRUE, alors la taille de la police sera moins limité vers les hautes valeurs
	 * @return
	 */
	...
	/**
	 * Dessine une chaine caractère en haut et en bas d'un rectangle graphique 
	 * @param uneCase La case à partir de laquelle on souhaite afficher la chaine
	 ...
	 * @param g L'objet graphics
	 * @param s1 La chaine de caractère que l'on souhaite afficher en haut de la case
